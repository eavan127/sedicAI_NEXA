...
def compute_class_weights(y, num_classes, dampen=None):
    ...
    whenever a real class looks ambiguous. Measured effect on main: it became
    the single largest source of errors for BPSK/QPSK/16QAM/64QAM/LFM_RADAR.
    Halving its weight makes that guess less rewarding without touching the
    other seven classes' balance.
    """

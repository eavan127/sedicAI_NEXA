...
class STFTBranchONNX(nn.Module):
    ...
    def forward(self, mag):
        ...
        # freq_summary, keep_rows or dwell_feature is on. torch.roll by
        # n_fft//2 IS fftshift for an even n_fft, and exports to plain
        # Slice/Concat, so the browser feeds this graph the same
        # raw-FFT-order magnitude it always did.
